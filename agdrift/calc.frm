...
' $Id: calc.frm,v 1.9 2003/07/11 14:47:27 tom Exp $
'Calculations form
'
...
'Perform the AgDRIFT calculations on the current data
'Returns:
'  0 = success
'  1 = errors
'  2 = halted
...
'
  ...
  'Set filter list
  CMDialog1.Filter = "All Files (*.*)|*.*|Data Files (*.agd)|*.agd"
...
'Update the Percent Completed Thermometer bar
  ...
  picTherm.Print s$
  picTherm.Line (0, 0)-(X, picTherm.Height), RGB(255, 0, 0), BF
  picTherm.Refresh
'
